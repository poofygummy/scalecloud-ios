...
- [x] **ScaleCloudSign/Sources/Setup/SetupCoordinator.swift** — removed anisettePreConfigured check in certificateTrustConfirmed(), removed credentialsPreConfigured skip in init() and start(from:)
- [x] **ScaleCloudSign/Sources/Utilities/UserDefaults+Setup.swift** — removed anisettePreConfigured and credentialsPreConfigured properties
...
- [x] Add DebuggerUtils.swift to ScaleCloudSign/Sources/Utilities/ (new file)
...
- [x] Add SecureEnclaveManager.swift to ScaleCloudSign/Sources/Utilities/ (new file)
...
- [x] **ScaleCloudSign/Sources/Utilities/DebuggerUtils.swift**
- [x] **ScaleCloudSign/Sources/Utilities/SecureEnclaveManager.swift**
...
- [x] **ScaleCloudSign/Sources/Setup/SetupCoordinator.swift** — added debugger detection + debug channel handoff flow
- [x] **ScaleCloudSign/Sources/Utilities/UserDefaults+Setup.swift** — removed pre-configuration flags
