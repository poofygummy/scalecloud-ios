...
- `ScaleCloudSign/Sources/Setup/SetupCoordinator.swift`
- `ScaleCloudSign/Sources/Setup/CredentialInputViewController.swift`
- `ScaleCloudSign/Sources/Setup/DeveloperModeViewController.swift`
- `ScaleCloudSign/Sources/Setup/TrustCertificateViewController.swift`
- `ScaleCloudSign/Sources/Setup/AnisetteConfigViewController.swift`
- `ScaleCloudSign/Sources/Setup/SetupCompleteViewController.swift`
- `ScaleCloudSign/Sources/Utilities/UserDefaults+Setup.swift`

## Files to Modify

- `ScaleCloudSign/project.yml` - ✅ Add UIKit framework dependency
