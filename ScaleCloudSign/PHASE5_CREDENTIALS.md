...
- [x] Copy Keychain.swift to `ScaleCloudSign/Sources/Security/`
...
### New Files
```
ScaleCloudSign/Sources/Security/Keychain.swift (adapted from SideStore)
ScaleCloudSign/Sources/Utilities/UserDefaults+Anisette.swift (new)
```

### Modified Files
```
ScaleCloudSign/Sources/Operations/BackgroundRefreshAppsOperation.swift (added expiry parsing)
```

### No Changes Required
```
ScaleCloudSign/Sources/Anisette/FetchAnisetteDataOperation.swift (already uses Keychain.shared)
ScaleCloudSign/project.yml (Security/ auto-detected by XcodeGen)
```
