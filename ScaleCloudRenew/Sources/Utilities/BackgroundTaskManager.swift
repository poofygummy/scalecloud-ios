...
final class BackgroundTaskManager
{
    ...
    private init()
    {
        ...
        do
        {
            // Look in ScaleCloudRenew framework bundle, fall back to main bundle
            let bundle = Bundle(for: type(of: self)) 
            let audioFileURL = bundle.url(forResource: "Silence", withExtension: "m4a")!
        ...
        self.audioEngineQueue = DispatchQueue(label: "com.scalecloud.BackgroundTaskManager")
    }
}
