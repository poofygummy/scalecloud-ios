...
final public class SCKRequestOptions: NSObject, @unchecked Sendable {
    ...
    public let createProperties: [SCKProperties]?
    public let removeProperties: [SCKProperties]
    ...
    public init(endpoint: String? = nil,
                ...
                createProperties: [SCKProperties]? = nil,
