...
///
/// Definition of properties used for decoding in ``SCKDataFileXML``.
///
public enum SCKProperties: String, CaseIterable {
    /// DAV
    ...
    static public func properties(createProperties: [SCKProperties]?, removeProperties: [SCKProperties] = []) -> String {
