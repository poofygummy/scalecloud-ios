...
public class SCKRecommendation: NSObject {
...
class XMLToRecommendationParser {
    func parse(xml: String) -> [SCKRecommendation]? {
        ...
        var recommendations: [SCKRecommendation] = []
        ...
        for element in elements {
            ...
            let recommendation = SCKRecommendation(
                id: id,
                timestamp: timestamp,
                name: name,
                directory: directory,
