...
public struct SCKError: Error, Equatable, Sendable {
    ...
    public static let urlError = SCKError(errorCode: NSURLErrorBadURL, errorDescription: NSLocalizedString("_invalid_url_", value: "Invalid server url", comment: ""))
    public static let invalidResponseError = SCKError(errorCode: NSURLErrorBadServerResponse, errorDescription: NSLocalizedString("_error_response_", value: "Invalid response", comment: ""))
    public static let xmlError = SCKError(errorCode: NSURLErrorBadServerResponse, errorDescription: NSLocalizedString("_error_decode_xml_", value: "Invalid response, error decoding XML", comment: ""))
    public static let invalidDate = SCKError(errorCode: NSURLErrorBadServerResponse, errorDescription: NSLocalizedString("_invalid_date_format_", value: "Invalid date format", comment: ""))
    public static let invalidData = SCKError(errorCode: NSURLErrorCannotDecodeContentData, errorDescription: NSLocalizedString("_invalid_data_format_", value: "Invalid data format", comment: ""))
    public static let unauthorizedError = SCKError(errorCode: 401, errorDescription: NSLocalizedString("_unauthorized_", value: "Unauthorized", comment: ""))
    public static let unavailableError = SCKError(errorCode: 503, errorDescription: NSLocalizedString("_Unavailable_", value: "Unavailable", comment: ""))
    public static let forbiddenError = SCKError(errorCode: 403, errorDescription: NSLocalizedString("_forbidden_", value: "Forbidden", comment: ""))
    public static let cancelled = SCKError(errorCode: -999, errorDescription: NSLocalizedString("_cancelled_", value: "Cancelled", comment: ""))

    public static let errorChunkFileNull = SCKError(errorCode: -9994, errorDescription: NSLocalizedString("_error_file_null_", value: "File not found", comment: ""))
    public static let errorChunkFilesEmpty = SCKError(errorCode: -9995, errorDescription: NSLocalizedString("_chunk_files_empty_", value: "Files not found", comment: ""))
    public static let errorChunkCreateFolder = SCKError(errorCode: -9996, errorDescription: NSLocalizedString("_error_create_folder_", value: "Create folder error", comment: ""))
    public static let errorChunkMoveFile = SCKError(errorCode: -9997, errorDescription: NSLocalizedString("_error_move_folder_", value: "Move file error", comment: ""))
    public static let errorChunkNoEnoughMemory = SCKError(errorCode: -9998, errorDescription: NSLocalizedString("_no_enough_memory_", value: "No enough memory", comment: ""))

    public static let success = SCKError(errorCode: 0, errorDescription: "")
    ...
    /// Creates an `SCKError` from an explicit code and description.
    ///
    /// - Parameters:
    ...
    /// Creates an `SCKError` from a generic Swift `Error`.
    ///
    /// - Parameters:
    ...
    /// Creates an `SCKError` from an `NSError`.
    ///
    /// - Parameters:
    ...
    /// Creates an `SCKError` from an OCS JSON response.
    ///
    /// - Parameters:
    ...
    public init(rootJson: JSON, fallbackStatusCode: Int?, responseData: Data? = nil) {
        ...
        if let dataMsg = rootJson[.ocsDataMsg].string {
            ...
            errorDescription = SCKError.getErrorDescription(for: statuscode) ?? SCKError.httpFallbackDescription(for: statuscode)
        }
    ...
    /// Creates an `SCKError` from an HTTP status code.
    ///
    /// - Parameters:
    ...
    public init(statusCode: Int, fallbackDescription: String, responseData: Data? = nil) {
        ...
        let description = SCKError.getErrorDescription(for: statusCode) ?? fallbackDescription
    ...
    /// Creates an `SCKError` from an HTTP response.
    ///
    ...
    /// Creates an `SCKError` from an OCS or WebDAV XML response.
    ///
    /// - Parameters:
    ...
    /// Creates an `SCKError` from an Alamofire response and optional Alamofire error.
    ///
    /// - Parameters:
    ...
    public static func == (lhs: SCKError, rhs: SCKError) -> Bool {
