...
public class SCKFileProperty: NSObject {
    public var classFile: SCKTypeClassFile = .unknow
    public var iconName: SCKTypeIconFile = .unknow
    public var name: String = ""
    public var ext: String = ""
}

public enum SCKTypeClassFile: String {
    case audio = "audio"
...
public enum SCKTypeIconFile: String {
    case audio = "audio"
    case code = "code"
    case compress = "compress"
    case directory = "directory"
...
/// Class responsible for resolving SCKFileProperty information from a given UTI.
public final class SCKFilePropertyResolver {
    ...
    public func resolve(
        ...
        let fileProperty = SCKFileProperty()
